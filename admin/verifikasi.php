...
?>
    ...
    <div class="mb-3">
        <a href="verifikasi.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <?php $tahap = $pendaftaran['tahap_pendaftaran'] ?? 1; ?>
                <span class="badge <?= $tahap == 1 ? 'bg-primary' : 'bg-warning text-dark' ?>">Tahap <?= $tahap ?></span>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <?php if (empty($pendingList)): ?>
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">Tidak ada data menunggu verifikasi</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
