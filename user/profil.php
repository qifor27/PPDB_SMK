...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!Session::verifyCsrf($_POST['csrf_token'] ?? '')) {
        ...
        if (!$error) {
            db()->update('tb_siswa', $data, 'id_siswa = ?', ['id_siswa' => $userId]);
        ...
        <div class="card text-center">
            <div class="card-body">
                ...
                <div class="text-start">
                    <p class="small mb-2"><i class="bi bi-envelope me-2 text-primary"></i><?= htmlspecialchars($siswa['email']) ?></p>
                    <p class="small mb-2"><i class="bi bi-phone me-2 text-primary"></i><?= htmlspecialchars($siswa['no_hp'] ?? '-') ?></p>
                    <p class="small mb-0"><i class="bi bi-calendar me-2 text-primary"></i>Bergabung: <?= formatDate($siswa['created_at'], 'd M Y') ?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <form method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="<?= htmlspecialchars($siswa['tempat_lahir']) ?>, <?= formatDate($siswa['tanggal_lahir']) ?>" disabled>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kelurahan" class="form-control" value="<?= htmlspecialchars($siswa['kelurahan'] ?? '') ?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12"><hr><h6>Ubah Password</h6></div>
                        
                        <div class="col-md-6">
                            <label class="form-label">Password Baru</label>
                            <input type="password" name="password_baru" class="form-control" placeholder="Kosongkan jika tidak diubah">
                        </div>
                        <div class="col-md-6">
