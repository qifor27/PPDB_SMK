...
$pendaftar = db()->fetchAll(
    "SELECT p.*, s.nama_lengkap, s.nisn, smk.nama_sekolah
            ...
            <div class="col-md-6">
                <form method="GET" class="d-flex gap-2">
                    <input type="text" name="search" class="form-control form-control-sm"
                        placeholder="Cari nama/nomor..." value="<?= htmlspecialchars($search) ?>">
                    ...
                    <?php else: ?>
                        <?php foreach ($pendaftar as $p): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="detail-pendaftar.php?id=<?= $p['id_pendaftaran'] ?>"
